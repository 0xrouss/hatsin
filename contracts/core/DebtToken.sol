...
/**
    @title Hatsin Debt Token "Nectar"
...
contract DebtToken is ERC20 {
    ...
    IMetaHatsinCore private immutable _metaHatsinCore;
    ...
    constructor(
        ...
        IMetaHatsinCore metaHatsinCore_,
        address _factory,
        address _gasPool,
        address _PSMBond,
        ...
        _metaHatsinCore = metaHatsinCore_;
        gasPool = _gasPool;
    ...
    // --- Functions for intra-Hatsin calls ---
    ...
    function _flashFee(uint256 amount) internal view returns (uint256) {
        uint effectiveFee = _metaHatsinCore.getPeripheryFlashLoanFee(msg.sender);
    ...
    function flashLoan(
        ...
        _transfer(address(receiver), _metaHatsinCore.feeReceiver(), fee);
        return true;
    }

    modifier onlyOwner() {
        require(_metaHatsinCore.owner() == msg.sender, "Caller not BeraborowCore::owner()");
        _;
    }
