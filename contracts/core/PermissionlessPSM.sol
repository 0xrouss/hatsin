...
contract PermissionlessPSM {
    ...
    IMetaHatsinCore public metaHatsinCore;
    ...
    constructor(address _metaHatsinCore, address _nect, address[] memory _stables, address _feeHook, address _feeReceiver) {
        if (_metaHatsinCore == address(0) || _nect == address(0) || _feeHook == address(0)) revert AddressZero();
